...
def generate(query: str, system_prompt: str="You are JARVIS. I am Bhardwaj Prasad Sutara your creator. Call me sir, I was born on 15 Jan 2010 in New Delhi, India. Be short with your responses.", model_id: str="gpt-3.5-turbo"):
    """
    ...
    # Define headers
    headers = {
        "Cookie": "gkp2=WA5rZxhPlZ6DDKiw3vfm",
